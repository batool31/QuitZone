...
<section class="hero">
  ...
  <a href="login.php" class="start-btn"><span>Stay on Track</span></a>
  <a href="login.php" class="start-btn secondary"><span>Learn More</span></a>
</div>
...
<section class="awareness-section">
  ...
  <div class="awareness-container">
    <div class="awareness-box" data-aos="fade-up" data-aos-delay="200">
      ...
      <a href="login.php" class="awareness-btn">Track Your Progress</a>
    </div>
    ...
    <div class="awareness-box" data-aos="fade-up" data-aos-delay="300">
      ...
      <a href="login.php" class="awareness-btn">View Your Savings</a>
    </div>
    ...
    <div class="awareness-box" data-aos="fade-up" data-aos-delay="400">
      ...
      <p>Secondhand smoke harms those around you. Quitting helps protect others too.</p>
       <a href="login.php" class="awareness-btn">Learn More</a>
    </div>
  </div>
</section>
        ...
        <div class="footer-links">
          <div class="footer-column">
            ...
            <ul>
              ...
              <li><a href="login.php">Progress</a></li>
              <li><a href="login.php">Challenges</a></li>
              <li><a href="login.php">Savings</a></li>
              <li><a href="login.php.php">Success Stories</a></li>
            </ul>
          </div>
