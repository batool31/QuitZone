      ...
      <div class="chat-main">
          ...
          <div class="chat-message bot animated-entrance">
            ...
            <div class="message-content">
              <div class="message-bubble">
                <p>👋 Hello! I'm QuitBot, your personal assistant on your journey to quit smoking. How can I help you today?</p>
              </div>
        ...
        <div class="emoji-picker" id="emoji-picker">
          <div class="emoji-header">
            <span>Add emoji</span>
            <button class="close-emoji" onclick="toggleEmojiPicker()">×</button>
          </div>
          <div class="emoji-categories">
            <button class="category-btn active" data-category="smileys"><span>😊</span></button>
            <button class="category-btn" data-category="gestures"><span>👍</span></button>
            <button class="category-btn" data-category="food"><span>🍎</span></button>
            <button class="category-btn" data-category="travel"><span>🚗</span></button>
            <button class="category-btn" data-category="objects"><span>⌚</span></button>
          </div>
  ...
  <script>
    ...
    function generateBotResponse(userMessage) {
      ...
      if (lowercaseMessage.includes('craving') || lowercaseMessage.includes('help with cravings')) {
        ...
        response = "Quitting smoking has immediate and long-term benefits:<br><br>• Within 20 minutes: Heart rate drops<br>• Within 12 hours: Carbon monoxide levels normalize<br>• Within 2 weeks: Circulation improves, lung function increases<br>• Within 1-9 months: Coughing and shortness of breath decrease<br>• Within 1 year: Heart attack risk drops dramatically<br>• Within 5-15 years: Stroke risk reduces to that of a non-smoker<br><br>And there are many more benefits to your health, finances, and quality of life!";
      }
        ...
        response = "Here's a timeline of health improvements after quitting:<br><br>• <strong>20 minutes:</strong> Heart rate normalizes<br>• <strong>12 hours:</strong> CO levels in blood drop to normal<br>• <strong>2-3 days:</strong> Sense of smell and taste improve<br>• <strong>2-3 weeks:</strong> Circulation improves, lung function increases<br>• <strong>1-3 months:</strong> Reduced coughing and shortness of breath<br>• <strong>1 year:</strong> Risk of coronary heart disease halves<br>• <strong>5-10 years:</strong> Stroke risk equals that of a non-smoker<br>• <strong>10+ years:</strong> Lung cancer risk significantly reduces<br>• <strong>15+ years:</strong> Heart disease risk equals a non-smoker";
      }
        ...
        response = "Thank you for sharing. I'm here to support your quit journey. Would you like information about:<br><br>• Dealing with cravings<br>• Managing withdrawal symptoms<br>• Benefits of quitting<br>• Creating a quit plan<br>• Finding support resources<br><br>Feel free to ask about any of these topics!";
      }
